...
function SvgBirthdayIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      />
      <path
        d="M13 6.73283C12.7064 6.90264 12.3651 7 12 7C11.6364 7 11.2946 6.90166 11 6.73026C10.4033 6.38314 10 5.73638 10 5C10 4.62 10.1 4.27 10.29 3.97L12 1L13.71 3.97C13.9 4.27 14 4.62 14 5C14 5.73821 13.5992 6.38635 13 6.73283Z"
        fill="currentColor"
      />
    </svg>
  );
