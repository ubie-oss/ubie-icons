  ...
  return (
    <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M2 17C2 18.1046 2.89543 19 4 19H6V21C6 22.5 7.5 23 8.5 22L11.5 19H20C21.1046 19 22 18.1046 22 17V5C22 3.89543 21.1046 3 20 3H4C2.89543 3 2 3.89543 2 5V17ZM8 19.6716V17H4V5H20V17H10.6716L8 19.6716Z"
        fill="currentColor"
      />
    </svg>
  );
