...
function SvgShowOutlineIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12 4.00488C6.95452 4.00488 2.65706 7.19886 1.06279 11.6655C0.985579 11.8818 0.985579 12.1182 1.06279 12.3345C2.65706 16.8012 6.95452 19.9952 12 19.9952C17.0455 19.9952 21.343 16.8012 22.9372 12.3345C23.0145 12.1182 23.0145 11.8818 22.9372 11.6655C21.343 7.19886 17.0455 4.00488 12 4.00488ZM12 18.0049C7.93966 18.0049 4.47172 15.5143 3.0639 12C4.47172 8.48573 7.93966 5.99515 12 5.99515C16.0604 5.99515 19.5283 8.48573 20.9361 12C19.5283 15.5143 16.0604 18.0049 12 18.0049Z"
        fill="currentColor"
      />
    </svg>
  );
